<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-RRNXB4YYNX"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-RRNXB4YYNX');
    </script>
              ...
              result.results.forEach(story => {
                ...
                <div class="car popular_card mb-3" >
                    ...
                    <div class="row g-0 justify-content-center ">
                        <div class="col-4">
                        <img src="${url}/public/storage/${story?.cover_photo[0].file}" class="img-fluid rounded-start popular_card-img " alt="Story Cover">
                        </div>
