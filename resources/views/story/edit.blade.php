...
{{-- <script src="{{asset('assets/plugins/filter-multi-select-main/dist/filter-multi-select-bundle.min.js')}}"></script> --}}
<script src="{{asset('assets/plugins/multi-select/dist/js/BsMultiSelect.min.js')}}"></script>

{{-- <link rel="stylesheet" href="{{asset('assets/plugins/filter-multi-select-main/dist/filter_multi_select.css')}}" /> --}}
       ...
       <div class="row">
            <div class="col-lg-6 offset-lg-0 col-sm-10 offset-sm-1 px-sm-0   col-12 px-2 ">
                <div class="post_img-container">
                    @if(count($story->cover_photo) > 0)
                        <img src="{{asset('storage/'.$story->cover_photo[0]->file)}}" alt="novelist" class="post_hero-img" style="width:100%;">
                    @else
                ...
                <div class="post_reg">
                    <div class="row">
                        ...
                        <div class=" col-lg-12 px-lg-4 col-md-8 col-sm-10 mx-sm-auto px-sm-0 offset-sm-0  col-10 offset-1">
                            ...
                            <p class="mt-lg-4 mt-md-3 mt-3 post_reg-subtitle  text-lg-start ">Change Cover Image</p>
                            <form action="{{route('update-story')}}" class="row g-3" method="post" id="story-form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col- post_input-div">
                                    ...
                                    <input name="title" id="title" class="form-control rounded-3" placeholder="Title" value="{{ $story->title }}" required>
                                    <div class="text-danger backend-msg">
                                        @error('title')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="col- post_input-div">
                                    ...
                                    <select class="js-example-basic-multiple  form-control" name="tags[]" id="tags" multiple="multiple" style="width: 100%;">
                                        ...
                                        @foreach ($tags as $tag)
                                            <option value="{{$tag->id}}" @if( in_array($tag->id, $story_tag_ids) ) selected  @endif>{{$tag->title}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col- post_input-div">
                                    ...
                                    <div id="storyholder" style="min-height:200px; border:2px solid silver!important" class="rounded" onchange="alert('yes')"><p id="story-paragraph"><?=$story->content?></p></div>
